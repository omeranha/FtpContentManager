...
namespace FTPcontentManager.Src.Extensions
{
	...
	public static class MethodInfoExtensions
	{
		...
		{
			return method.DeclaringType.GetMethod(method.Name, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
		}
		...
		public static PropertyInfo GetProperty(this MethodInfo method)
		{
			...
			return type.GetProperty(method.Name.Substring(4), BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
		}
