...
using FTPcontentManager.Src.Gpd;
...
namespace FTPcontentManager.Src.Stfs
{
    public abstract class StfsPackage : Package<StfsVolumeDescriptor>
    {
        ...
        protected override void Parse()
        {
            ...
            Gender = (VolumeDescriptor.BlockSeparation & 1) == 1 ? Gender.Female : Gender.Male;
        ...
        {
            var blockStep = 0xAB;
            if (Gender == Gender.Male) blockStep++;
        ...
        private int GetRealBlockNum(int blockNum)
        {
            ...
            var byteGender = Convert.ToByte(Gender);
